...
//const TicketsData = (resultado, collection, setTicketFields, rol, dialogStore) => {
const TicketsData = (resultado, setTicketFields, rol, dialogStore) => {
  const baseColumns = [
    {
      field: "visualizar",
      headerName: "Ver",
  ...
  const rows = resultado.map((ticket) => ({
    ...ticket,
