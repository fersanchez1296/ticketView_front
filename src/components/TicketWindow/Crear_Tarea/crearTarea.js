...
const Creartarea = ({ form, formState }) => {
  const [selectedFiles, setSelectedFiles] = React.useState([]);

  // Función modificada para agregar archivos sin eliminar los previos
    ...
    <Grid container spacing={2} m={1}>
      <Grid item xs={12}>
        <TextField
          ...
          {...form.register("Descripcion_tarea", {
...
export default React.memo(Creartarea);
